(function () {
        if (typeof swfobject != 'undefined') {
                ...
                if ((!window.jQuery && (gameType.test("unity") || gameType.test("html5") )) || flashPlayerVersion.major > 10 || (flashPlayerVersion.major > 9 && flashPlayerVersion.minor > 1)) {
...
var Disney = Disney || {};
Disney.launchGame = function (gameConf) {
