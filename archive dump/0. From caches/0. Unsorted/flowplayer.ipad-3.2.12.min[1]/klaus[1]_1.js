...
window.piximedia.Klaus = {
	...
	getSiteLive: function(roger, house) {
		...
		} else if(host.search("huffingtonpost.fr") >= 0) { 
			return "HUFFINGTON_POST";
		} else {
			return house.site;
		}
	},
...
roger.log('top: ' + (moveTops + headerHeight) + 'px !important; position: relative !important;');
			...
			case 'PUREPEOPLE':
			case 'PURETREND':
				roger.createCSS('body.pmHabillage #wb_body','width: 1000px !important');
				roger.createCSS('body.pmHabillage #wb_header','position: absolute; top: -' + roger.getMoveTops() + 'px; width: 1000px;');
				roger.createCSS('div#wb_nav_top','z-index: 2147483645 !important');
			...
			roger.log("socialHeight: " + socialHeight);
				...
				*/
				...
				roger.createCSS('#wb_nav_top', 'z-index: 2 !important');
...
//roger.createCSS('body.pmHabillage .pmGoToTheTop .pmMasthead', 'background-color: red; z-index: 999999 !important; position: relative !important; left: -100px !important;')
			...
			case 'HUFFINGTON_POST':
				window.piximedia.Klaus.fixSiteFallback(roger, house);
				roger.createCSS('body.pmHabillage #hp_cconsent', "display: none");
				roger.createCSS('body.pmHabillage .pmGoToTheTop','top: 0px !important');
				break;
