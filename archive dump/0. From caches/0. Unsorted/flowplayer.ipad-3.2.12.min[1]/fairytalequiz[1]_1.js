    ...
    */
    ...
    global.QUIZ = (function () {
        ...
        */
        ...
        /**
        * Gets the user's alliance by counting up the answers to the questions.
        * @return {Object} Object containing alliance number, allianceName, royal/rebel points.
        * @example
        *
        * // example response
        * {
        ...
        */
            getAlliance = function () {
                var numQuestions = _.keys(state.answers).length, // todo: perhaps use questions.length here instead?
                    neutralPoints = parseInt(globalSettings.neutralThresholdFraction * numQuestions, 10),
                    royalPoints,
                    rebelPoints,
                    ret = {};

                /**
                * counts num of questions answered for a specific alliance
                * NOTE:
                * 0 = neutral
                * 1 = royal
                * 2 = rebel
                * @param  {string} alliance royal or rebel
                * @return {number} total number of questions answered for alliance
                */
                ...
                var sumPoints = countPoints();
                ret.sumPoints = sumPoints;
                ret.totalPoints = numQuestions;
                if (sumPoints <= 33 && sumPoints >= 25) {
                    ret.alliance = '2'; // royal
                    ret.allianceName = 'madeline';
                    ret.allianceId = "madeline";
                } else if (sumPoints <= 17 && sumPoints >= 10) {
                    ret.alliance = '0'; // rebel
                    ret.allianceName = 'apple';
                    ret.allianceId = "apple";

                } else if (sumPoints <= 24 && sumPoints >= 18) {
                    ret.alliance = '1'; // neutral
                    ret.allianceName = 'briar';
                    ret.allianceId = "briar";

                } else if (sumPoints <= 40 && sumPoints >= 34) {
                    ret.alliance = '3'; // neutral
                    ret.allianceName = 'raven';
                    ret.allianceId = "raven";
                ...
                initialize: function () {
                    ...
                    dispatcher.once('mirrorpadButtonClicked', function () {
                        ...
                        global.MAT.analytics.whenTealiumIsReady(function () {
                            global.utag.track("view", { event_id: "FairyTale Quiz: Start", event_category_id: "Links" });
                        });
            ...
            ResultView = ScreenView.extend({
                ...
                render: function (settings) {
                    ...
                    _.delay(function () {
                        ...
                        updateScrollbar();
                        cleanViews(3);
                        if ($('.ftimageFrame img').length > 0) {
                            var tmpImg = new Image() ;
                            tmpImg.src = $('.ftimageFrame img').attr('src');
                    ...
                    dispatcher.on('mirrorpadButtonClicked', function () {
                        // tealium tracking
                        global.MAT.analytics.whenTealiumIsReady(function () {
                            global.utag.track("view", { event_id: "FairyTale Quiz: Print Result", event_category_id: "Downloads" });
                        });
                ...
                render: function (settings) {
                    ...
                    if (Modernizr.touch === false) {
						...
						clip.on( "complete", function(client, args) {
                            // tealium tracking
							global.MAT.analytics.whenTealiumIsReady(function () {					
								global.utag.track("view", { event_id:"FairyTale Quiz: Share Result", event_category_id:"Social" });
							});
                        });
                    } else {
            ...
            Router: Backbone.Router.extend({
                ...
                result: function () {
                    var resultView = new ResultView(),
						...
						// tealium tracking
						global.MAT.analytics.whenTealiumIsReady(function () {						
							global.utag.track("view", { event_id: "FairyTale Quiz: Complete [" + allianceName + "]", event_category_id: "Links" });
						});
