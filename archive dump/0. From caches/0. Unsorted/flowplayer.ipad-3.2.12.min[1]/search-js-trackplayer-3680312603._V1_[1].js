...
if(typeof amznJQ!="undefined"){amznJQ.declareAvailable("swfobjectJS");
}function a2z_1p_AMPlayerProd_DoFSCommand(command,args){var argArray=new Array();
argArray=args.split("\t");
if(command=="TrackStateChanged"){a2z_1p_setTrackPreviewState(argArray[0],argArray[1]);
}}function fe_a2z_1p_AMPlayerProd_DoFSCommand(command,args){a2z_1p_AMPlayerProd_DoFSCommand(command,args);
}function a2z_1p_getFlashMovieObject(objectId){var obj=window.document[objectId];
...
}}function a2z_1p_trackPreviewPressed(asin){var flashContentDiv=document.getElementById("a2z_1p_chiDiv");
...
}var a2z_1p_STATEID_LOADING=1;
var a2z_1p_STATEID_STOPPED=2;
var a2z_1p_STATEID_PAUSED=3;
var a2z_1p_STATEID_PLAYING=4;
var a2z_1p_STATEID_ERROR=5;
var a2z_1p_TrackPlayerImages=new Array();
...
}function a2z_1p_setTrackPreviewState(asin,state){var trackPreviewImage=document.getElementById("a2z_1p_trackPreview"+asin);
if(trackPreviewImage==null){trackPreviewImage=document.getElementById("fe_a2z_1p_trackPreview"+asin);
...
}}}function a2z_1p_stopPlayer(){var albumSampler=a2z_1p_getFlashMovieObject("a2z_1p_AMPlayerProd");
if(albumSampler==null){albumSampler=a2z_1p_getFlashMovieObject("fe_a2z_1p_AMPlayerProd");
}if(albumSampler){albumSampler.TCallLabel("/","PausePlayback");
}}function a2z_1p_setPlaylistURL(playlistURL){var albumSampler=a2z_1p_getFlashMovieObject("a2z_1p_AMPlayerProd");
if(albumSampler==null){albumSampler=a2z_1p_getFlashMovieObject("fe_a2z_1p_AMPlayerProd");
}if(albumSampler){albumSampler.SetVariable("_root.playlistToSet",playlistURL);
albumSampler.TCallLabel("/","SetPlaylist");
}}var a2z_1p_oldWidth;
function a2z_1p_setVisible(isVisible){var albumSampler=a2z_1p_getFlashMovieObject("a2z_1p_AMPlayerProd");
if(albumSampler==null){albumSampler=a2z_1p_getFlashMovieObject("fe_a2z_1p_AMPlayerProd");
...
}}}function a2z_1p_setAMDCookieValue(value){var albumSampler=a2z_1p_getFlashMovieObject("a2z_1p_AMPlayerProd");
if(albumSampler==null){albumSampler=a2z_1p_getFlashMovieObject("fe_a2z_1p_AMPlayerProd");
}if(albumSampler){albumSampler.SetVariable("_root.AMDCookieValue",value);
albumSampler.TCallLabel("/","SetAMDCookieValue");
}}function a2z_1p_getAMDCookieValue(){var flashAMDCookieValue=null;
var albumSampler=a2z_1p_getFlashMovieObject("a2z_1p_AMPlayerProd");
if(albumSampler==null){albumSampler=a2z_1p_getFlashMovieObject("fe_a2z_1p_AMPlayerProd");
...
}function varIsUndef(v){return((v==undefined)||(v==null)||(v=="undefined")||(v=="null"));
}function syncFlashAndHTTPCookies(){var cookieSync="normal";
...
}function fp_resizePlayerSpace(nsPrefix,w,h){try{var ifrm=parent.document.getElementById(nsPrefix+"movieFrameID");
if(ifrm){var h2=h+35;
...
}}function fp_rewriteDiv(nsPrefix,divName,html){document.getElementById(nsPrefix+divName).innerHTML=html;
}function embeddingPopup(nsPrefix){alert("placeholder function for embedding code");
}function a2z_1p_embeddingPopup(){alert("Embedding code will be displayed here.");
}var a2z_1p_textString='<div id="a2z_1p_videoPlaceholder" style="position:relative;"><div id="a2z_1p_clipDiv" style="position:relative; overflow:visible; "><div id="a2z_1p_flashcontent"><span id="a2z_1p_flash_not_installed" style="font-size: 10px;">To view this content, download <a href="http://get.adobe.com/flashplayer">Flash player</a> (version 8.0.0.0 or higher)</span></div></div></div>';
var a2z_1p_so;
function a2z_1p_loadSwf_Core(swfLocation,swfWidth,swfHeight,flashVersion,bgColor,swfParams,flashParams,embedAttributes){try{a2z_1p_so=new SWFObject(swfLocation,"a2z_1p_AMPlayerProd",swfWidth,swfHeight,flashVersion,bgColor);
...
}function getPlaylistTracks(){var asinsList=jQuery(".srTrack").map(function(){return jQuery(this).attr("name");
});
return jQuery.makeArray(asinsList).join("");
}function _a2z_1p_loadSwf(movieID,playerVersion){if(amznJQ&&amznJQ.available){amznJQ.available("JQuery",function(){var playlist=getPlaylistTracks();
...
}}function a2z_1p_loadSwf(movieID,playerVersion){return _a2z_1p_loadSwf(movieID,playerVersion);
}amznJQ.declareAvailable("search-js-trackplayer");
