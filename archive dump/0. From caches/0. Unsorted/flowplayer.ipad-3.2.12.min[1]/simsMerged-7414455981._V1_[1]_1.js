...
amznJQ.available("jQuery",function(){var $=amznJQ.jQuery;
if(typeof $.fn.callOnVisible!="undefined"){return;
...
amznJQ.available("callOnVisible",function(){var $=amznJQ.jQuery;
window.sims_initShovelerFeature=function(feature){var dataEl=$("#"+feature+"SimsData");
...
if(typeof amznJQ!="undefined"){amznJQ.declareAvailable("simsJS");
}});
