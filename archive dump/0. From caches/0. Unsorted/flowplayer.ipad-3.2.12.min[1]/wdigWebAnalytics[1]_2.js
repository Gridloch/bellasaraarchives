...
var digStagingALHost = "//staging.analytics.disneyinternational.com/analytics/";
...
function digWAObjSubmit()
{
	...
	if (digWAObj.useWebService) {
		...
		var report = digWAObj;
		digIncludeJavaScript('//analytics.disneyinternational.com/analytics/tags/tagsv2.php?site=' + digWAUrlSite + '&uri=' + digWAUrl + "&hash=" + encodeURIComponent(window.location.hash) + "&search=" + encodeURIComponent(window.location.search));
	} else {
